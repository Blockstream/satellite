...
First you must verify that the Blockstream Satellite coverage in your area operates within the LNB frequency range. You can check the coverage area and satellite frequencies on our [Network Status](https://blockstream.com/satellite/#satellite_network-coverage) page.
...
To find the ideal location to place your antenna, first use the following tool to find the correct azimuth and elevation. https://blockstream.com/satellite/#satellite-resources (click on the "Dish Alignment Tool" on the right).
...
>
>To find your frequency, first go to https://blockstream.com/satellite/#satellite_network-coverage and find your satellite.  You should see the frequency listed in MHz.
>
